...
class Principal extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      title: "Aplicacion de sitios turisticos",
      home: HomePrincipal() ,
    );
  }
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title:Text("..Sitios Truisticos..",),
        backgroundColor: Colors.blueGrey[600],
        foregroundColor: Color.fromARGB(255, 10, 168, 5),
        ),
        body: ListView.builder(
          itemCount: sitiosTuristicos.length,
          itemBuilder: (BuildContext context, int index) {
            return Card(
              color: sitiosTuristicos[index]['color_distintivo'][50],
              child: ListTile(
                        ...
                        body: Padding(
                          ...
                          child: ListView(
                            children: [
                              ...
                              Divider(color: sitiosTuristicos[index]['color_distintivo'],
                              ),
                              Text(
                              sitiosTuristicos[index]['fecha_lanzamiento']+"-"+
                              sitiosTuristicos[index]['generacion']),
